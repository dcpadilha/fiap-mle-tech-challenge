...
def dag_vitbrasil_extract_importation_uvas_passas():
    ...
    def run_scrapping(ds = None, ds_nodash = None, **kwargs):
        ...
        utils.delete_data("Importacao", "Uvas Passas", year)

        base_url = f"http://vitibrasil.cnpuv.embrapa.br/index.php?ano={year}&opcao=opt_05&subopcao=subopt_04"  
    ...
    def save_on_database(**kwargs):
        utils.save_database_value_and_qtde(kwargs["ti"].xcom_pull(key="dados"), "Importacao", "Uvas Passas")
