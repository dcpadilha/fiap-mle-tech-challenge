...
def dag_vitbrasil_extract_process_viniferas():
    ...
    def run_scrapping(ds = None, ds_nodash = None, **kwargs):
        ...
        utils.delete_data("Processamento", "Viniferas", year)

        base_url = f"http://vitibrasil.cnpuv.embrapa.br/index.php?ano={year}&opcao=opt_03&subopcao=subopt_01"  
    ...
    def save_on_database(**kwargs):
        utils.save_database(kwargs["ti"].xcom_pull(key="dados"), "Processamento", "Viniferas")
