...
def dag_vitbrasil_extract_exportation_suco_uva():
    ...
    def run_scrapping(ds = None, ds_nodash = None, **kwargs):
        ...
        utils.delete_data("Exportacao", "Suco de Uva", year)

        base_url = f"http://vitibrasil.cnpuv.embrapa.br/index.php?ano={year}&opcao=opt_06&subopcao=subopt_04"  
    ...
    def save_on_database(**kwargs):
        utils.save_database_value_and_qtde(kwargs["ti"].xcom_pull(key="dados"), "Exportacao", "Suco de Uva")
