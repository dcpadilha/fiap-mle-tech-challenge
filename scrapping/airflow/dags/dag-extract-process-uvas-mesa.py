...
def dag_vitbrasil_extract_process_uvas_mesa():
    ...
    def run_scrapping(ds = None, ds_nodash = None, **kwargs):
        ...
        utils.delete_data("Processamento", "Uvas de Mesa", year)
    ...
    def save_on_database(**kwargs):
        utils.save_database(kwargs["ti"].xcom_pull(key="dados"), "Processamento", "Uvas de Mesa")
