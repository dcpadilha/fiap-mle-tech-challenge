...
def dag_vitbrasil_extract_exportation_vinhos_mesa():
    ...
    def run_scrapping(ds = None, ds_nodash = None, **kwargs):
        ...
        utils.delete_data("Exportacao", "Vinhos de Mesa", year)

        base_url = f"http://vitibrasil.cnpuv.embrapa.br/index.php?ano={year}&opcao=opt_06&subopcao=subopt_01"  
    ...
    def save_on_database(**kwargs):
        utils.save_database_value_and_qtde(kwargs["ti"].xcom_pull(key="dados"), "Exportacao", "Vinhos de Mesa")
