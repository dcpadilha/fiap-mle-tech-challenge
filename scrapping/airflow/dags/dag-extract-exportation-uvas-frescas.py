...
def dag_vitbrasil_extract_exportation_uvas_frescas():
    ...
    def run_scrapping(ds = None, ds_nodash = None, **kwargs):
        ...
        utils.delete_data("Exportacao", "Uvas Frescas", year)

        base_url = f"http://vitibrasil.cnpuv.embrapa.br/index.php?ano={year}&opcao=opt_06&subopcao=subopt_03"  
    ...
    def save_on_database(**kwargs):
        utils.save_database_value_and_qtde(kwargs["ti"].xcom_pull(key="dados"), "Exportacao", "Uvas Frescas")
